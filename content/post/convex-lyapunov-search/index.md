...
Here, the objective is the linearization of $(\det\mathbf{P})^{-\frac{1}{2}}$ at $\mathbf{P} = \mathbf{P}^{(k+\frac{1}{2})}$, which is proportional to the volume of $\{ \bm{x} \mid V(\bm{x}) \leq 1 \}$.
